...
When using Ollama as a provider with oh-my-openagent-gpt agents, you may encounter:
...
- **oh-my-openagent-gpt**: Passes through the SDK's behavior (can't fix at this layer)
...
- **oh-my-openagent-gpt**: https://github.com/code-yeongyu/oh-my-openagent/issues/1124 (closed - workaround documented)
