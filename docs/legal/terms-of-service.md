...
These Terms of Service govern your use of oh-my-opencode-gpt and oh-my-openagent-gpt, including the published CLI package, the OpenCode plugin runtime, the repository, and related distribution materials.

For these Terms, "Application" means the published `oh-my-opencode-gpt` package and plugin. "Service" means the Application and related project distribution surfaces. "We" and "our" refer to the maintainer of oh-my-openagent-gpt. "You" refer to the individual or entity using the Service.
