/**
 * Unified system directive prefix for oh-my-openagent-gpt internal messages.
 * All system-generated messages should use this prefix for consistent filtering.
 *
 * Format: [SYSTEM DIRECTIVE: OH-MY-OPENAGENT-GPT - {TYPE}]
 */

export const SYSTEM_DIRECTIVE_PREFIX = "[SYSTEM DIRECTIVE: OH-MY-OPENAGENT-GPT"
 ...
 * @returns Formatted directive string like "[SYSTEM DIRECTIVE: OH-MY-OPENAGENT-GPT - TODO CONTINUATION]"
 */
...
/**
 * Checks if a message starts with the oh-my-openagent-gpt system directive prefix.
