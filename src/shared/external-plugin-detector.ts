/**
 * Detects external plugins that may conflict with plugin features.
...
/**
 * Known notification plugins that conflict with this plugin's session-notification.
...
/**
 * Known skill plugins that conflict with this plugin's skill loading.
